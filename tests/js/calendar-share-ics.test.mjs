...
async function fixture({ shares = [], saveResponse = null, detailResponse = null } = {}) {
    ...
    return { document, state, share, modal: () => state.ui.shareModalEl, saveResponse, detailResponse, rotateRequestSawOldUrl: () => rotateRequestSawOldUrl, saveCalls: () => saveCalls };
}
